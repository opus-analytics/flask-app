...
window.onload = async () => {
  ...
  await fetch(
    window.location.protocol + "//" + window.location.host + "/get-competency",
    {
      method: "POST",
      headers: {
  ...
  if (resp.jobSkills != null) {
    introductoryText.textContent =
      "Your results have been stored securely and can be accessed by " +
      resp.name +
      ". This information will be used to evaluate skills and performance by the platform.This link is expired for security reasons. You can close this window now.";
