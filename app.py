...
app = Flask(__name__)
CORS(app, origins=['http://localhost:5173/*', "https://opusanalytics.ai/", "https://kind-mushroom-05279770f.2.azurestaticapps.net/", "https://opus-analytics.azurewebsites.net/"], supports_credentials=True)
